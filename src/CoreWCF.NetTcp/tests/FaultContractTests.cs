    ...
    public class FaultContractTests
    {
        ...
        public void FaultOnDiffContractAndOps()
        {
            ...
            using (host)
            {
                ...
                var factory = new System.ServiceModel.ChannelFactory<ClientContract.ITestFaultOpContract>(binding,
                    new System.ServiceModel.EndpointAddress($"{host.GetNetTcpAddressInUse()}/BasicWcfService/FaultOnDiffContractsAndOpsService.svc"));
                ClientContract.ITestFaultOpContract channel = factory.CreateChannel();

                var factory2 = new System.ServiceModel.ChannelFactory<ClientContract.ITestFaultOpContractTypedClient>(binding,
                    new System.ServiceModel.EndpointAddress($"{host.GetNetTcpAddressInUse()}/BasicWcfService/FaultOnDiffContractsAndOpsService.svc"));
        ...
        public void DatacontractFaults(string f)
        {
            ...
            using (host)
            {
                ...
                var factory = new System.ServiceModel.ChannelFactory<ClientContract.ITestDataContractFault>(binding,
                    new System.ServiceModel.EndpointAddress($"{host.GetNetTcpAddressInUse()}/BasicWcfService/DatacontractFaults.svc"));
                ClientContract.ITestDataContractFault channel = factory.CreateChannel();

                var factory2 = new System.ServiceModel.ChannelFactory<ClientContract.ITestDataContractFaultTypedClient>(binding,
                    new System.ServiceModel.EndpointAddress($"{host.GetNetTcpAddressInUse()}/BasicWcfService/DatacontractFaults.svc"));
        ...
        internal class Startup
        {
            ...
            public void Configure(IApplicationBuilder app)
            {
                app.UseServiceModel(builder =>
                {
                    ...
                    builder.AddServiceEndpoint<FaultOnDiffContractsAndOpsService, ServiceContract.ITestFaultOpContract>(new NetTcpBinding(SecurityMode.None),
                        "/BasicWcfService/FaultOnDiffContractsAndOpsService.svc");
                    builder.AddService<DatacontractFaultService>();
                    builder.AddServiceEndpoint<DatacontractFaultService, ServiceContract.ITestDataContractFault>(new NetTcpBinding(SecurityMode.None),
                        "/BasicWcfService/DatacontractFaults.svc");
                });
            }
        }
    }
